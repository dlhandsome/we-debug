...
module.exports = function (options = {}) {
  ...
  const init = () => through.obj((file, encoding, callback) => {
    if (!isInit) {
      try {
  ...
  const injectComponentId = () => through.obj((file, encoding, callback) => {
    if (file.extname === '.wxml') {
      ...
      Object.getOwnPropertyNames(usingComponents).forEach(component => gogo
